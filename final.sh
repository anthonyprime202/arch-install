...
sudo pacman -Syu ripgrep qtile sddm alacritty discord firefox nemo lxsession lxappearance qt5ct qt6ct rofi dunst neofetch blueman network-manager-applet kdeconnect cbatticon maim neovim nitrogen
